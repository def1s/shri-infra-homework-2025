...
Привет! Если у тебя возникнут проблемы с запуском actions или созданием PR, то напиши мне в ТГ -> _@def1s0_  
Скорее всего для корректной проверки нужно добавить тебя в collaborators, чтобы была возможность запускать CI/CD  
Адрес деплоя -> http://89.169.188.229/hw/store
